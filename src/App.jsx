...
function WheelPicker({options,selected,onChange}){
  ...
  return el("div",{style:{position:"relative",height:IH*3,flex:1,background:BG2,borderRadius:14,overflow:"hidden"}},
