...
export default function App(){
  ...
  if(screen==="onboarding")return el("div",{style:{fontFamily:"'Plus Jakarta Sans',sans-serif",background:BG,color:T1,minHeight:"100vh",maxWidth:480,margin:"0 auto"}},el("style",null,CSS),el(OnboardingScreen,{onComplete:p=>{setProfile(p);setScreen("app");}}));

  return el("div",{style:{fontFamily:"'Plus Jakarta Sans',sans-serif",background:BG,color:T1,minHeight:"100vh",maxWidth:480,margin:"0 auto",position:"relative",overflowX:"hidden"}},
    el("style",null,CSS),
